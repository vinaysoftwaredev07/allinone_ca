...
class TransactionsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.transaction.create', compact('roles'));
    }
    ...
    public function edit(Services $service)
    {
        ...
        return view('admin.transaction.edit', compact('service', 'documents'));
    }
    ...
    public function show(Services $service)
    {
        ...
        return view('admin.transaction.show', compact('service'));
    }
