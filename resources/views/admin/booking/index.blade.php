            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.booking.fields.sample') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($bookings as $key => $booking)
                        <tr data-entry-id="{{ $booking->id }}">
                            ...
                            <td>
                                <img src="{{ $booking->sample ?? '' }}" width="50px" height="50px"  />
                            </td>
                            <td>
                                {{ $booking->description ?? '' }}
                            </td>
                            <td>
                                {!! $booking->status == 1 ? '<span class="badge badge-success">Active</span>' : '<span class="badge badge-danger">Inactive</span>' !!}
                            </td>
                            <td>
                                @can('user_show')
