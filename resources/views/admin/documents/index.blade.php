            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.documents.fields.description') }}
                        </th>
                        <th>
                            {{ trans('cruds.documents.fields.status') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($documents as $key => $document)
                        <tr data-entry-id="{{ $document->id }}">
                            ...
                            <td>
                                {!! $document->status == 1 ? '<span class="badge badge-success">Active</span>' : '<span class="badge badge-danger">Inactive</span>' !!}
                            </td>
                            <td>
                                @can('user_show')
